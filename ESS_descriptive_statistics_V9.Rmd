...
-   **Adjusted R²** = 0.361 → Shows good explanatory power with minimal overfitting
...
-   **`rlgatnd_rev` (ns)**: Religious attendance is **not significantly**
    related to EU trust.
...
**Model Overview**
-   N = 9,088 respondents from Poland
-   R² = 0.292 → The model explains 29.2% of the variance in trust in the European Parliament
-   Residual Std. Error = 2.158 → Slightly higher error than in the full model
